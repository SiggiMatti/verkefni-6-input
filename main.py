...
# forsíðan með íslengskum stöfum
with open('../verkefni-6/index.html', 'w', encoding='utf-8') as file:
    file.write(index_html)


# forsíðan
with open('../verkefni-6/bread.html', 'w') as file:
...
for post in POSTS:
    ...
    post_file_path = '../verkefni-6/posts/{slug}.html'.format(slug=post_metadata['slug'])
